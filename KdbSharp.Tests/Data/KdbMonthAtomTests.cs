...
namespace KdbSharp.Tests.Data
{
    ...
    public class KdbMonthAtomTests
    {
        ...
        private readonly KdbMonthAtom _null = new KdbMonthAtom(Null);
        private readonly KdbMonthAtom _negativeInfinity = new KdbMonthAtom(NegativeInfinity);
        private readonly KdbMonthAtom _positiveInfinity = new KdbMonthAtom(PositiveInfinity);
